...
**Functionality:** Author-only login using email/password (or SSO provider).
Readers do not authenticate. They access drafts through signed, author-generated
review links. Error states show inline under the field with a ⚠ prefix.
After 3 failed attempts, a CAPTCHA dialog appears in a separate MacWindow.
...
reader_policy:
  access_model: "No reader login"
  reader_entry: "/r/{reader_link_token}"
  token_properties:
    signed: true
    single_reader_scoped: true
    revocable: true
...
│░░░░  │  (Readers join via secure review links)  │  ░░░░░░░░░░░░░│
│░░░░  │                                          │  ░░░░░░░░░░░░░│
│░░░░  │  Name                                    │  ░░░░░░░░░░░░░│
│░░░░  │  ┌────────────────────────────────────┐  │  ░░░░░░░░░░░░░│
│░░░░  │  │ Your name                          │  │  ░░░░░░░░░░░░░│
...
**Functionality:** Author account creation only. Reader accounts are removed.
After signup, authors go to onboarding → first article creation. Readers
join directly through secure links generated by the author.
...
layout:
  ...
  - button:
      ...
      primary: true
      full_width: true
      action: auth.signup_author(name, email, password)
...
│  └──────────────────────────────────────────┘                    │
│                                                                  │
│  Access: ◉ Unique reader links (no login)                        │
│          ○ Open link (shared, no login)                          │
...
invalidates old links). Three access modes: unique per-reader links,
open shared link, or password-protected link. Reader visibility toggles
control whether readers can see other people's reactions (useful for
preventing groupthink in early rounds, per the beta reading guide).
Authors can enable/disable individual reaction types or add custom
ones. Status controls whether the article appears as active or archived.
...
layout:
  ...
  - radio_group:
      ...
      options:
        ...
        - { value: password, label: "Password protected link", sub_field: { id: password, type: password } }
...
│░░░░  │  Name (optional)                             │  ░░░░░░░░░│
│░░░░  │  ┌────────────────────────────────────────┐  │  ░░░░░░░░░│
│░░░░  │  │ Alex (shown to author unless hidden)   │  │  ░░░░░░░░░│
│░░░░  │  └────────────────────────────────────────┘  │  ░░░░░░░░░│
│░░░░  │                                              │  ░░░░░░░░░│
...
layout:
  ...
  - divider: { text: "Start review" }
  - field: { id: reader_name, label: "Name (optional)", placeholder: "How should we identify your feedback?" }
  - button: { label: "Start Reading Now", primary: true, action: review.start_from_token(token, reader_name) }
  - link: { text: "Continue anonymously", action: review.start_from_token(token, null) }

  - conditional:
      if: "article.access_mode in ['link','invite_link']"
      show:
        note: "No account is required for readers."
...
```
                    ┌────────────────┐
                    │ Author Login   │◄── Forgot Password
                    │ Author Signup  │◄── Email Verify
                    └───────┬────────┘
                            │
                      ┌─────▼─────┐
                      │  AUTHOR   │
...
*This spec covers the complete product from author auth → onboarding → authoring → link sharing → reading → analytics → team management → billing.*
